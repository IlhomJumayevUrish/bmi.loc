			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="{{ route('appoinment-page')}}" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Make appoinment <i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<a href="{{ route('appoinment-page')}}" class="btn btn-main btn-round-full">Make a appoinment</a>
					</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-4">
				<div class="about-content pl-4 mt-4 mt-lg-0">
					...
					<a href="{{ route('service-page')}}" class="btn btn-main-2 btn-round-full btn-icon">Services<i class="icofont-simple-right ml-3"></i></a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-6 col-md-10 ">
				<div class="appoinment-wrap mt-5 mt-lg-0">
					...
					<form id="#" class="appoinment-form" method="post" action="#">
						...
						<a class="btn btn-main btn-round-full" href="{{ route('appoinment-page')}}">Make Appoinment <i class="icofont-simple-right ml-2  "></i></a>
					</form>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12 testimonial-wrap-2">
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{$new->image_s}}" alt="" class="img-fluid">
					</div>
