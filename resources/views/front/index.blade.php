	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
		 	 <a class="navbar-brand" href="index.html">
			  	<img src="/front/images/logo.png" alt="" class="img-fluid">
			  </a>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
					<img src="/front/images/about/img-1.jpg" alt="" class="img-fluid">
					<img src="/front/images/about/img-2.jpg" alt="" class="img-fluid mt-4">
				</div>
			</div>
			<div class="col-lg-4 col-sm-6">
				<div class="about-img mt-4 mt-lg-0">
					<img src="/front/images/about/img-3.jpg" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-4">
			...
			<div class="col-lg-12 testimonial-wrap-2">
				<div class="testimonial-block style-2  gray-bg">
					...
					<div class="testimonial-thumb">
						<img src="/front/images/team/test-thumb1.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="/front/images/team/test-thumb2.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="/front/images/team/test-thumb3.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="/front/images/team/test-thumb4.jpg" alt="" class="img-fluid">
					</div>
		...
		<div class="row clients-logo">
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="/front/images/about/1.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="/front/images/about/2.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="/front/images/about/3.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="/front/images/about/4.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="/front/images/about/5.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="/front/images/about/6.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
...
<footer class="footer section gray-bg">
    ...
    <!-- Bootstrap 4.3.2 -->
    <script src="/front/plugins/bootstrap/js/popper.js"></script>
    <script src="/front/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="/front/plugins/counterup/jquery.easing.js"></script>
    <!-- Slick Slider -->
    <script src="/front/plugins/slick-carousel/slick/slick.min.js"></script>
    <!-- Counterup -->
    <script src="/front/plugins/counterup/jquery.waypoints.min.js"></script>
    
    <script src="/front/plugins/shuffle/shuffle.min.js"></script>
    <script src="/front/plugins/counterup/jquery.counterup.min.js"></script>
    <!-- Google Map -->
    <script src="/front/plugins/google-map/map.js"></script>
