...
@section('title', 'Добавить социальный контакт')
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Добавить социальный контакт</h4>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" id="digits" value="{{ old('url')}}" name="url" data-parsley-required="true" placeholder="URL-адрес" />
                                </div>
                            </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="#" onclick="upload_image()">
                                <img src="/assets/img/gallery/add.png" alt="" id="blah" class="w-100" height="130">
