                    ...
                    <div class="form-group row m-b-15">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <input class="form-control" type="text" id="fullname" value="{{ $contact->name}}" name="name" placeholder="Name" data-parsley-required="true" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-12 col-sm-12 col-form-label" for="message">URL<span class="text-red">*</span></label>
                            <div class="col-md-12 col-sm-12">
                                <input class="form-control" type="text" id="digits" value="{{ $contact->url}}" name="url" data-parsley-required="true" placeholder="URL" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <select name="status" id="status" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
                                    <option value="active" {{ $contact->status=='avtive'?'selected':''}}>Active</option>
