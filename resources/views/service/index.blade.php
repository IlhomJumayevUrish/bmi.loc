...
<div class="panel panel-inverse">
    ...
    <div class="panel-heading">
        <h1 class="panel-title">Перечень услуг</h1>
        <div class="panel-heading-btn">
            <a href="{{route('service-create')}}" class="btn btn-green btn-xs ">Создавать</a>
        </div>
    </div>
    <!-- end panel-heading -->
    <!-- begin panel-body -->
            ...
            <tbody>
                ...
                <tr class="odd gradeA">
                    ...
                    <td>
                        ...
                        <a href="{{ route('service-edit',$product->id)}}" class="btn btn-default btn-icon btn-circle btn-lg">
