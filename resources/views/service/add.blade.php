    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Создать сервис</h4>
                <div class="panel-heading-btn">
                    <a href="{{ route('service-index')}}" class="btn btn-xs btn-icon btn-circle btn-default"><i class="fa fa-hand-point-left"></i></a>
            ...
            <div class="panel-body">
                <form class="form-horizontal" data-parsley-validate="true" name="demo-form" action="{{ route('service-store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea class="form-control" required id="wysihtml5" name="description" rows="4" placeholder="Описание...">{{ old('description')}}</textarea>
