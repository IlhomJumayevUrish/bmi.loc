...
<div class="panel panel-inverse">
    ...
    <div class="panel-heading">
        <h1 class="panel-title">Категория</h1>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label for="type">Тип<span class="text-red">*</span></label>
            ...
            <tbody>
                ...
                <tr class="odd gradeA">
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0)" onclick='delete_news("{{$category->id}}")' class="btn btn-default btn-icon btn-circle btn-lg">
                            <i class="fa fa-trash fa-fw m-r-5" style="color: red;"></i>
                            <form action="{{ route('category-delete',$category->id)}}" method="POST" id="partner-delete{{$category->id}}">
                                @csrf
                            </form>
                        </a>
                    </td>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" id="name" required name="name" value="{{$category->name}}" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <select class="form-control" name="type">
                                                                    ...
                                                                    <option value="service" {{$category->type=="service"?'selected':''}}>Услуга</option>
                                                                </select>
                                                                <span class="text-red">@error('status'){{$message}}@enderror</span>
                                                            </div>
                                                        </div>
